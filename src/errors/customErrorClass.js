...
class CARDError extends Error {
   ...
   *
   * throw new CARDError( { "key": "value" }, NAMES.NOT_FOUND, TEMPLATES.ORDER_ITEMS_FOR_ORDER_NOT_FOUND);
   *
   */
  constructor({data = {}, name = NAMES.UNKNOWN_ERROR, err = ""}) {
    ...
    // Maintains proper stack trace for where our err`or was thrown (only available on V8)
